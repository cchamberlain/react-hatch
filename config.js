...
exports.resolveRoot = exports.__rootname = exports.log = exports.baseUrl = exports.IS_BROWSER = exports.IS_DEV = exports.IS_HOT = exports.noop = exports.name = undefined;
...
var name = exports.name = 'react-hatch';
...
var log = exports.log = !IS_DEV && IS_BROWSER ? { name: name, trace: noop, debug: noop, info: noop, warn: noop, error: noop, fatal: noop } : (0, _bunyan.createLogger)({ name: name, level: 'info' });
