...
export const log = !IS_DEV && IS_BROWSER ? ({ name, trace: noop, debug: noop, info: noop, warn: noop, error: noop, fatal: noop }) : createLogger({ name, level: 'info' })
